...
CRM_SERVICE_URL = os.getenv("CRM_SERVICE_URL", "http://127.0.0.1:9001/crm")
...
class PDF(FPDF):
    ...
    def header(self):
        ...
        self.cell(0, 6, 'CredFlow Finance', 0, 1, 'C')
        self.ln(1)
    ...
    def footer(self):
        ...
        self.cell(0, 4, 'CredFlow Finance', 0, 1, 'C')
        self.cell(
            0, 4,
            'Registered Office: Ashok Rajpath, Patna, Bihar - 800005.',
            0, 1, 'C'
        )
...
async def generate_sanction_pdf(request) -> Optional[str]:
    ...
    pdf.multi_cell(
        ...
        "CredFlow Finance (hereinafter referred to as the \"Company\") "
    ...
    # Signatures
    pdf.cell(0, 5, "For CredFlow Finance", ln=1)
    pdf.ln(15)
